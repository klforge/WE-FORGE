...
const FAQPage = () => {
  ...
  return (
    <div className="faq-page">
      <button className="faq-page__back" onClick={() => navigate('/')}>
      ...
      <div className="faq-page__container">
        ...
        <div className="faq-page__left">
          <div className="faq-page__breadcrumbs">
            <span onClick={() => navigate('/')}>Home</span> / <span className="faq-page__breadcrumbs--active">FAQ's</span>
          </div>
